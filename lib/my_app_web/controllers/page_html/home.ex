defmodule MyAppWeb.HomeLive.Index do
  ...
  |> assign(video: Evision.VideoCapture.videoCapture("/Users/katelynnburns/Documents/Zoom/2023-07-25 10.51.03 Katelynn (she_her)'s Zoom Meeting/video1536544321.mp4"))
  }
  end
  ...
  defp predict(serving, frame) do
    ...
    tensor = frame |> Evision.cvtColor(7) |> Evision.gaussianBlur({3, 3}, 0, SigmaY: 0)
    canny = Evision.canny(tensor, 100, 200)
    {contours, _} = Evision.findContours(canny, Evision.Constant.cv_RETR_LIST(), Evision.Constant.cv_CHAIN_APPROX_NONE())

#     minimal_area = 100_000
